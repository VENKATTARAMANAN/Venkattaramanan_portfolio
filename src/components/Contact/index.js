...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    const value= { service:"service_zqeimxq",template:"template_3s1kwa4",public:"npgKKr2F5xKID41wD" };
    console.log({
        ...
        <div className="flex-auto w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/VENKATTARAMANAN", "_blank")
                }
              >
              ...
              <div
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/venkatta-ramanan-147b64126/",
                    "_blank"
                  )
                }
              >
            ...
            <div className="mt-6 italic text-sm font-medium text-blue-500 ">
              ...
              <span>2023 Venkattaramanan C</span>
            </div>
          </div>
        </div>
        <ToastContainer
